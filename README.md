...
- `POST /api/seller/apply` - 商家入驻申请
- `POST /api/seller/upload/{fileType}` - 上传商家资质图片
- `GET /api/seller/info` - 获取商家信息
- `GET /api/seller/products` - 获取商家商品列表
- `POST /api/seller/products` - 添加商品
- `PUT /api/seller/products/{id}` - 更新商品
- `DELETE /api/seller/products/{id}` - 删除商品
- `POST /api/seller/products/image` - 上传商品图片
- `GET /api/seller/orders` - 获取商家订单列表
- `POST /api/seller/orders/{orderNo}/ship` - 发货
- `PUT /api/seller/products/{id}/stock` - 更新商品库存
- `PUT /api/seller/products/stock/batch` - 批量更新商品库存
- `GET /api/seller/dashboard` - 获取商家统计数据
...
```typescript
// 商家入驻申请
applyAsSeller(data: SellerApplyData)

// 上传商家资质图片
uploadSellerDocument(fileType: string, file: File)

// 获取商家信息
getSellerInfo()

// 更新商家信息
updateSeller(data: SellerData)
...
// 获取商家订单列表
getSellerOrders(params: OrderQuery)
...
// 批量更新商品库存
batchUpdateProductStock(stockMap: Record<number, number>)
